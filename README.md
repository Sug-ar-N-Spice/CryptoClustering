...
# K-means algorithm and principal component analysis (PCA)
...
# Troubleshooting_Crypto_Clustering vs Crypto_Clustering.ipynb

The purpose of the Troubleshooting_Crypto_Clustering file is to provide explict thought process as data scientist worked through this exercise. It is overly detailed and would not be ideal for presenting to other codes as it is not concise. However, Data Scientist "Freshers" may chose to keep seperate notes as to what they performed and then clean it up for presentation purposes. 

Crypto_Clustering.ipynb and associated data files is what is expected to be presented to the team.
